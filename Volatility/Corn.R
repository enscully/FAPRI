...
ggplot(corn)  + 
  ...
  geom_line(aes(x=Date, y=DecNC, color = "lines"), stat="identity", size=1)+
...
ggplotly(ggplot(corn) + 
           ...
           geom_ribbon(aes(x = Date, ymin = corn$DecNC - corn$volatilityDec * 3, ymax = corn$DecNC + corn$volatilityDec * 3), linetype = 2, alpha=0.25) + 
           
           geom_line(aes(x = Date, y = corn$DecNC + corn$volatilityDec * 2), linetype = 2, alpha=0.5, col = "blue") +
           geom_line(aes(x = Date, y = corn$DecNC - corn$volatilityDec * 2), linetype = 2, alpha=0.5, col = "blue") +
           geom_line(aes(x = Date, y = corn$DecNC + corn$volatilityDec * 3), linetype = 2, alpha=0.5, col = "forestgreen") +
           geom_line(aes(x = Date, y = corn$DecNC - corn$volatilityDec * 3), linetype = 2, alpha=0.5, col = "forestgreen") +
...
ggplotly(ggplot(corn) + 
           ...
           geom_ribbon(aes(x = Date, ymin = corn$NearbyOC - corn$volatilityNearby * 3, ymax = corn$NearbyOC + corn$volatilityNearby * 3), linetype = 2, alpha=0.25) + 
           
           geom_line(aes(x = Date, ymin = corn$NearbyLower, ymax = corn$NearbyUpper), linetype = 2, alpha=0.25, col = "blue") +
           geom_line(aes(x = Date, y = corn$NearbyOC - corn$volatilityNearby * 2, ymax = corn$NearbyOC + corn$volatilityNearby * 2), linetype = 2, alpha=0.25, col = "forestgreen") +
           geom_line(aes(x = Date, y = corn$NearbyOC + corn$volatilityNearby * 2), linetype = 2, alpha=0.25, col = "blue") +
           geom_line(aes(x = Date, ymin = corn$NearbyOC - corn$volatilityNearby * 2, ymax = corn$NearbyOC + corn$volatilityNearby * 2), linetype = 2, alpha=0.25, col = "forestgreen") +
...
plot1 = ggplot(data = averageVolatility[1:9,]) + 
  geom_line(aes(x = as.factor(year[1:9]), y = DecNC[1:9], color = "one"), group = 1) +
